...
export default class MainMenu extends Scene {
    ...
    public loadScene(): void {
        ...
        this.load.image("background", "hw4_assets/images/background.png");
        this.load.image("control", "hw4_assets/images/control.png");
        this.load.image("help", "hw4_assets/images/help.png");
    }
